...
Linnear model THIS IS STILL TO COME




```{r no_trial biomass vs biomass survey, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
## The fit of models biomass vs survey data THIS IS STILL TO COME




```{r no_trial biomass vs biomass survey model fit1, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
The Pheonm LAI has the best correlations but the R2 is 0.XX.


`summary(lm( kg_ha~  value, data = no_trial_biomass_long_Phen_LAI_no))`


```{r no_trial biomass vs biomass survey best model fit, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
no_trial_biomass_long_Phen_LAI_no <- no_trial_biomass_long %>% 
  filter(survey_type == "Survey_Phen_LAI")
...
biomass = xx +  xx * Phenom Dist survey value
...
```{r phenom DIST converted to biomass no trial, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
